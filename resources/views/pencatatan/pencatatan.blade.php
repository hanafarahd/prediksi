...
@section('content')
    <div class="pt-3 px-4 overflow-auto">
        <div class="card overflow-auto">
            <div class="card-body" style="width: 175.6%">
                    ...
                    <table class="table table-responsive table-sm table-bordered table-striped text-center "
                        ...
                        <tbody>
                            @foreach ($pencatatan as $p)
                                @php
                                    $cutoffDate = $p->cutoff_date ? Carbon\Carbon::parse($p->cutoff_date) : null;
                                    ...
                                    $lamaJatuhTempo =
                                        $dueDate && $cutoffDate ? $dueDate->diffInDays($cutoffDate, false) : null;
                                @endphp
