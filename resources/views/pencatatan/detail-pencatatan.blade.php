                                    ...
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            <label for="invoice" class="form-label">Invoice<label
                                                    class="text-red">*</label></label>
                                            <input type="text" class="form-control" value="{{ $pencatatan->invoice }}"
                                                id="invoice" name="invoice" readonly>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            <label for="due_date" class="form-label">Due Date<label
                                                    class="text-red">*</label></label>
                                            <input type="text" class="form-control" value="{{ $pencatatan->due_date }}"
                                                id="due_date" name="due_date" readonly>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            <label for="trans_date" class="form-label">Trans Date<label
                                                    class="text-red">*</label></label>
                                            <input type="text" class="form-control" value="{{ $pencatatan->trans_date }}"
                                                id="trans_date" name="trans_date" readonly>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control"
                                                value="{{ $pencatatan->cutoff_date }}" id="cutoff_date" name="cutoff_date"
                                                readonly>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-sm-12 mt-3">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control hasil-prediksi"
                                                    id="p_piutang_display" value="{{ $pencatatan->p_piutang }}"
                                                    name="p_piutang_display" required disabled>
